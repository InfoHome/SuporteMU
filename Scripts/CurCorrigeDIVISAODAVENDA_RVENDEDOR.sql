...
--------------------------------------------------------------------------
/* 
 *** ESTE SCRIPT RELACIONA RPessoa DO VENDEDOR NA TABELA DIVISAO DA VENDA
 * - É NECESSÁRIO QUE O VENDEDOR QUE NÃO TIVER O RPESSOA RELACINADO SEJA
 * - RELACIONADO ANTES DE RODAR ESTE SCRIPT
*/
-------------------------------------------------------------------------
