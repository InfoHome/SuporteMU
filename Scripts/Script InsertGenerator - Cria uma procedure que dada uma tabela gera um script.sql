/****************************************************************************
Descrição: Este script cria uma procedure que dada uma tabela gera um script
de INSERT com os dados da tabela.

Autor: Narayana Vyas Kondreddi
Link original : http://vyaskn.tripod.com/code.htm#inserts

Exemplo:
USE pubs
GO
EXEC sp_generate_inserts 'basecalfat'
GO
