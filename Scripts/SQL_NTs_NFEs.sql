...
?/*
Para utilização das versões?: ??252.00 ou superior do MuEcf.exe?; ??252.00 ou superior do Tradfcxa.exe ?;? 96.216 ou superior do Masteren.exe?;
?É imprescindível que os scripts abaixo sejam executados:
*/

/*------ ATD 313087 ------*/
IF NOT EXISTS (SELECT 1 FROM SYSCOLUMNS WHERE name = 'TRANSACAOCARTAO' and syscolumns.id IN (SELECT ID FROM SYSOBJECTS WHERE xtype='U' AND name='NSU_ADMINISTRADORA')) 
ALTER TABLE TRANSACAOCARTAO ALTER COLUMN NSU_ADMINISTRADORA VARCHAR(30)

IF NOT EXISTS (SELECT 1 FROM SYSCOLUMNS WHERE name = 'TRANSACAOCARTAO' and syscolumns.id IN (SELECT ID FROM SYSOBJECTS WHERE xtype='U' AND name='NSU_SITEF')) 
ALTER TABLE TRANSACAOCARTAO ALTER COLUMN NSU_SITEF VARCHAR(30)

IF NOT EXISTS (SELECT 1 FROM SYSCOLUMNS WHERE name = 'TRANSACAOCARTAO' and syscolumns.id IN (SELECT ID FROM SYSOBJECTS WHERE xtype='U' AND name='NSU_CONCILIA')) 
ALTER TABLE TRANSACAOCARTAO ALTER COLUMN NSU_CONCILIA VARCHAR(254)

/*------ ATD 300257 ------*/

IF NOT EXISTS (SELECT 1 FROM SYSCOLUMNS WHERE name = 'TAMANHORETORNO' and syscolumns.id IN (SELECT ID FROM SYSOBJECTS WHERE xtype='U' AND name='FORCFFISFAT')) 
ALTER TABLE FORCFFISFAT ADD TAMANHORETORNO NUMERIC(15) not null default 0
go


IF NOT EXISTS (SELECT 1 FROM SYSCOLUMNS WHERE name = 'TAMANHORETORNO' and syscolumns.id IN (SELECT ID FROM SYSOBJECTS WHERE xtype='U' AND name='FORCFNFFAT')) 
