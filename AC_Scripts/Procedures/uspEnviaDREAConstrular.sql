...
/****** Object:  StoredProcedure [dbo].[AC_uspDREAConstrular]    Script Date: 20/06/2018 13:38:02 ******/
SET ANSI_NULLS ON
GO
...
-- EXEC AC_uspDREAConstrular  
ALTER PROCEDURE [dbo].[AC_uspDREAConstrular]  
as  
...
SELECT DISTINCT   
 ...
 FILIAL.CODIGO            as [Filial],  
 T.HIERARQUIANUMERO + ' - ' + T.NOME       as [TPO],   FATOFINANCEIRO_R.VALOR          as [VALOR]  
...
-- // FIM DESPESAS -------------------------------------------------------------------------  
--------------------------------------------------------------------------------------------  
-- Alteração de Despesas para Filial 04:
--------------------------------------------------------------------------------------------
UPDATE #tmpDRE_Despesas SET FILIAL = '04' WHERE LEFT(HIERARQUIA,10) IN (
			...
			--'04.006.007',	-- ISS Nanhane falou que não era para alterar
			--'04.006.002',	-- ICMS Nanhane falou que não era para alterar
			--'04.006.001',	-- SIMPLES NACIONAL Nanhane falou que não era para alterar
  )
