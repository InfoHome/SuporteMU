...
/****** Object:  StoredProcedure [dbo].[CARGA_BI_COMERCIAL]    Script Date: 28/05/2018 16:17:30 ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRANSACTION            
INSERT INTO tab_NIVEL12_CONST (NIVEL12, DESCRICAO) SELECT DISTINCT NIVEL12, 'PRODUTO ' + NIVEL12            
                          FROM NIVEL12_CONST            
...
--=====================================================================            
BEGIN TRANSACTION            
UPDATE TAB_NIVEL12_CONST SET DESCRICAO = upper(P.DESCR),            
                          COMPRADOR = P.COMPRADOR            
           FROM TAB_NIVEL12_CONST, BDENTER.DBO.PRODUTOCAD P            
           WHERE NIVEL12 = RIGHT('00000' + LTRIM(RTRIM( P.CODPRO )),5)            
COMMIT            
            
BEGIN TRANSACTION            
UPDATE TAB_NIVEL12_CONST SET comprador = upper(NOME)            
           FROM TAB_NIVEL12_CONST, BDENTER.DBO.COMPRADCAD            
